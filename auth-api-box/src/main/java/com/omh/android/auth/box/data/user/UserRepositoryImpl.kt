...
package com.omh.android.auth.box.data.user

import android.content.Context
import android.content.SharedPreferences
import com.omh.android.auth.api.models.OmhUserProfile
import com.omh.android.auth.box.data.user.datasource.BoxUserDataSource
...
internal class UserRepositoryImpl(
    private val boxUserDataSource: UserDataSource,
    private val ioDispatcher: CoroutineDispatcher,
) : UserRepository {

    override suspend fun handleIdToken(idToken: String, clientId: String) {
        withContext(ioDispatcher) {
            boxUserDataSource.handleIdToken(idToken, clientId)
        }
    }

    override fun getProfileData(): OmhUserProfile? {
        return boxUserDataSource.getProfileData()
    }
    ...
    companion object {
        ...
        fun getUserRepository(
            ...
            if (userRepository == null) {
                ...
                val userDataSource: UserDataSource = BoxUserDataSource(sharedPreferences)
