...
package com.omh.android.auth.box.presentation.redirect

import android.content.Intent
import android.net.Uri
import androidx.activity.viewModels
import com.omh.android.auth.box.factories.ViewModelFactory
...
class RedirectActivity : RedirectActivity() {
    ...
    override val viewModel: RedirectViewModel by viewModels {
        ViewModelFactory(requireNotNull(intent.getStringExtra(CLIENT_SECRET)))
    }

    override val providerShortName: String = PROVIDER_BOX
