...
import com.omh.android.auth.mslive.data.login.AuthRepositoryImpl
import com.omh.android.auth.mslive.data.user.UserRepositoryImpl
...
class OmhAuthClientImpl private constructor(
    ...
    override fun getLoginIntent(): Intent {
        return Intent(
            applicationContext,
            com.omh.android.auth.mslive.presentation.redirect.RedirectActivity::class.java
        )
