...
internal class DropboxAuthDataSource(
    private val context: Context,
    private val authService: DropboxAuthRest,
    private val apiService: DropboxApiRest,
    ...
    override fun buildLoginUrl(
        ...
        return AUTH_URI.toUri().buildUpon()
            ...
            .appendQueryParameter(Constants.PARAM_TOKEN_ACCESS_TYPE, OFFLINE_VALUE)
            .build()
    }
    ...
    override suspend fun revokeToken(clientId: String, token: String): ApiResult<Unit> {
        return (apiService.revokeToken("Bearer $token"))
    }
    ...
    companion object {
        private const val AUTH_URI = "https://www.dropbox.com/oauth2/authorize"
        private const val CODE_VALUE = "code"
        private const val OFFLINE_VALUE = "offline"

        @JvmStatic
        fun formatRedirectUri(context: Context): String {
            val scheme = context.getString(R.string.com_omh_android_auth_dropbox_oauth2_redirect_scheme)
            val host = context.getString(R.string.com_omh_android_auth_dropbox_oauth2_redirect_host)
            val pathPrefix = context.getString(R.string.com_omh_android_auth_dropbox_oauth2_redirect_pathPrefix)
