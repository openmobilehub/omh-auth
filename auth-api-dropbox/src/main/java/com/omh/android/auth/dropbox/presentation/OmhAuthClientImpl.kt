...
package com.omh.android.auth.dropbox.presentation
...
import com.omh.android.auth.dropbox.data.login.AuthRepositoryImpl
import com.omh.android.auth.dropbox.data.user.UserRepositoryImpl
...
class OmhAuthClientImpl private constructor(
    ...
    override fun getLoginIntent(): Intent {
        return Intent(
            applicationContext,
            com.omh.android.auth.dropbox.presentation.redirect.RedirectActivity::class.java,
        )
    ...
    class Builder(
        ...
        private var authScope: String = "openid profile email account_info.read"
